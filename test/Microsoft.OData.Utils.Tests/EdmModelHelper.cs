...
namespace Microsoft.OData.Utils.Tests
{
    internal static class EdmModelHelper
    {
        private static IEdmModel _productAndCategory;

        public static IEdmModel GetProductCategoryModel()
        {
            if (_productAndCategory != null)
            {
                return _productAndCategory;
            }
    ...
    <Schema xmlns=""http://docs.oasis-open.org/odata/ns/edm""
      ...
      <EntityContainer Name=""DemoService"">
        ...
        <FunctionImport Name=""ProductsByRating"" EntitySet=""Products""
            ...
            _productAndCategory = CsdlReader.Parse(XElement.Parse(csdl).CreateReader());
            return _productAndCategory;
        }
    }
}
